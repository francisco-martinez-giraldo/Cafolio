                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-8 w-8 p-0 opacity-50 cursor-pointer"
                      disabled
                    >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <DeleteConfirmDialog
                      ...
                      description="¿Estás seguro de que quieres eliminar esta preparación? Esta acción no se puede deshacer."
                      onConfirm={() => {
                      ...
                      isLoading={deletePreparation.isPending}
                    />
                  </TooltipTrigger>
                  <TooltipContent>
